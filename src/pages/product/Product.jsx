...
export default function Product() {
    ...
    const product = useSelector((state) => state.user.product.products.find((product) => product._id === productId));
    ...
    useEffect(() => {
        const getStats = async () => {
            try {
                const res = await userRequest.get("/users/stats/month?productId=" + productId);
